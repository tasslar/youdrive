...
@section('head')
<!-- DataTables -->
<link rel="stylesheet" href="{{ asset('admintemplate/plugins/datatables/dataTables.bootstrap.css')  }}">
...
<script src="{{ asset('admintemplate/plugins/datatables/dataTables.bootstrap.min.js')  }}"></script>
<!-- SlimScroll -->
