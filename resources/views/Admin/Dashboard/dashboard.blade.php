...
<!-- Sparkline -->
<script src="{{ asset('admintemplate/plugins/sparkline/jquery.sparkline.min.js')  }}"></script>
<!-- jvectormap -->
...
<!-- ChartJS 1.0.1 -->
<script src="{{ asset('admintemplate/plugins/chartjs/Chart.min.js')  }}"></script>
<!-- AdminLTE dashboard demo (This is only for demo purposes) -->
<script src="{{ asset('admintemplate/dist/js/pages/dashboard2.js')  }}"></script>
