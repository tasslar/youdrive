        ...
        <div class="col-md-12">
          ...
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              ...
              <li class="edit_blade"><a href="#tab_2" class="manage_country" data-toggle="tab"  data_url="{{route('addarea',['area_id'=> $area['id']])}}"><i class="fa fa-plus"></i> &nbsp; neues Land hinzufügen</a></li>
